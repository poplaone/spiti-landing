...
export const EnhancedTourCard = ({
  ...
  return (
    ...
    >
      <div className="relative bg-black/70 backdrop-blur-xl rounded-2xl overflow-hidden shadow-xl border border-skyblue/10">
        {/* Image without overlay gradient */}
        <div className="relative h-60 overflow-hidden">
          ...
          />
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent h-16 pointer-events-none"></div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-3">
            <div className="flex items-center mt-2">
              ...
              <span className="text-white/90 text-sm font-medium">
                <span className="text-skyblue-light">{duration.nights} Nights</span> {duration.days} Days
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="p-3 border-b border-skyblue/10">
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between mb-4 px-2">
            <div className="flex flex-col items-center">
              <Bed className="h-5 w-5 text-skyblue-light mb-1" />
              <span className="text-xs text-white/80">Hotels</span>
            </div>
            <div className="flex flex-col items-center">
              <Binoculars className="h-5 w-5 text-skyblue-light mb-1" />
              <span className="text-xs text-white/80">Sightseeing</span>
            </div>
            <div className="flex flex-col items-center">
              <Utensils className="h-5 w-5 text-skyblue-light mb-1" />
              <span className="text-xs text-white/80">Meals</span>
            </div>
            <div className="flex flex-col items-center">
              <Car className="h-5 w-5 text-skyblue-light mb-1" />
          ...
          <div className="mt-4">
            <div className="text-white text-center py-2 font-semibold rounded-t-lg bg-gradient-to-r from-skyblue-dark to-skyblue-light">
            ...
            <div className="grid grid-cols-2 gap-px bg-white/20">
              {priceOptions.map((option, idx) => (
                <div key={idx} className="bg-black/90 p-3 text-center">
                  ...
                  <div className="text-xs text-skyblue-light">{option.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          {privateOptions && (
            <div className="mt-px">
              <div className="text-white text-center py-2 font-semibold bg-gradient-to-r from-skyblue-dark to-skyblue-light">
                For Private Tour
              </div>
                ...
                <div className="grid grid-cols-5 gap-px bg-white/20">
                  {privateOptions.passengerOptions.map((option, idx) => (
                    <div key={idx} className="bg-black/90 p-2 text-center">
                      <div className="text-xs text-skyblue-light">{option}</div>
          ...
          <div className="grid grid-cols-2 gap-px mt-px bg-white/20">
            <div className="bg-gradient-to-r from-skyblue-dark to-skyblue p-2 text-center">
            ...
            <div className="bg-black/90 p-2 space-y-1.5">
              {inclusions.map((item, idx) => (
                <div key={idx} className="flex items-start">
                  <Check className="h-4 w-4 text-skyblue-light mr-1.5 mt-0.5 flex-shrink-0" />
          ...
          <Button className="w-full mt-4 bg-gradient-to-r from-forest-dark to-forest-light hover:from-forest hover:to-forest text-white shadow-none hover:shadow-none">
            SEND ENQUIRY
          </Button>
        </div>
      </div>
