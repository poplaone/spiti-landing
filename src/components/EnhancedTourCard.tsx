...
export const EnhancedTourCard = ({
  ...
  return <div className={cn("group opacity-0 animate-fade-in w-full max-w-md mx-auto", "transition-all duration-500 hover:transform hover:scale-[1.01]")} style={{
    ...
    animationFillMode: 'forwards'
      ...
      <div className="relative bg-black/70 backdrop-blur-xl rounded-2xl overflow-hidden shadow-xl border border-white/10">
        ...
        <div className="p-5">
          ...
          <div className="mt-4">
            <div className="text-white text-center py-2 font-semibold rounded-t-lg bg-yellow-500">
          ...
          {privateOptions && <div className="mt-px">
              <div className="text-white text-center py-2 font-semibold bg-yellow-500">
                For Private Tour
              </div>
              
              {privateOptions.onDemand ? <div className="bg-black/80 p-3 text-center">
          ...
          <div className="grid grid-cols-2 gap-px mt-px bg-white/20">
            ...
            <div className="bg-black/80 p-2 space-y-1.5">
              {exclusions.map((item, idx) => <div key={idx} className="flex items-start">
